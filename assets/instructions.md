...
Single source of {tool} instructions for this repository. Roles map to the agent files in `.claude/agents/`. Skills live in `{skillsPath}`.
...
- Methodology: `{skillsPath}/workflow/references/planning-methodology.md`.
- Risk analysis: `{skillsPath}/workflow/references/risk-analysis.md`.
- Plan format: `{skillsPath}/workflow/references/plan-format.md`.
...
- Review format: `{skillsPath}/workflow/references/review-format.md`.
...
- Report format: `{skillsPath}/workflow/references/implementation-format.md`.
- Implementation quality: `{skillsPath}/workflow/references/implementation-quality-guidelines.md`.
